...
?>  
    ...
    <div class="form-group">  
        ...
        <input type="text" id="name" name="name" value="<?= htmlspecialchars($user_data->getName()) ?>" required="true">  
    </div>  
    <div class="form-group">  
        <label for="username" class="required">Username: </label>  
        <input type="text" id="username" name="username" value="<?= htmlspecialchars($user_data->getUsername()) ?>" required>  
    </div>  
    <div class="form-group">  
        <label for="firstname" class="required">Firstname: </label>  
        <input type="text" id="firstname" name="firstname" value="<?= htmlspecialchars($user_data->getFirstname()) ?>" required>  
    </div>  
    <div class="form-group">  
        <label for="lastname" class="required">Lastname: </label>  
        <input type="text" id="lastname" name="lastname" value="<?= htmlspecialchars($user_data->getLastname()) ?>" required>  
    </div>  
    <div class="form-group">  
        <label for="email" class="required">Email: </label>  
        <input type="email" id="email" name="email" value="<?= htmlspecialchars($user_data->getEmail()) ?>" required>  
    </div>  
